...
const translations = {
  ...
  pt: {
    ...
    proj_pc_title:        "Desenvolvimento de Produtos — Casos e Soluções",
    proj_pc_desc:         "Projeto mecânico end-to-end: da concepção à manufatura. Soluções técnicas inovadoras para diferentes contextos industriais, do campo à fábrica.",
    proj_mod_title:       "Modelagem e Simulações Estruturais",
    proj_mod_desc:        "Geometrias de suspensão para veículos comerciais. Análise de elementos finitos e fadiga.",
    proj_motorsport_title:"Motorsport e Dinâmica Veicular",
    proj_motorsport_desc: "5 anos na equipe RS Racing UFRGS: liderança de suspensão, projeto de peças usinadas, aquisição de dados e competições nacionais.",
    ...
    proj_explorer_title:  "Exploradora — Viagens, Natureza e Cultura",
    proj_explorer_desc:   "Curiosidade sem limites: exploro desertos, florestas, cidades históricas e culturas ao redor do mundo com o mesmo entusiasmo que dedico à engenharia e ao artesanato.",
  ...
  en: {
    ...
    proj_pc_title:        "Product Development — Cases & Solutions",
    proj_pc_desc:         "End-to-end mechanical design: from concept to manufacture. Innovative technical solutions across different industrial contexts, from the field to the factory floor.",
    proj_mod_title:       "Modeling & Structural Simulations",
    proj_mod_desc:        "Suspension geometry for commercial vehicles. Finite element and fatigue analysis.",
    proj_motorsport_title:"Motorsport & Vehicle Dynamics",
    proj_motorsport_desc: "5 years at RS Racing UFRGS: suspension leadership, machined part design, data acquisition, and national competitions.",
    ...
    proj_explorer_title:  "Explorer — Travel, Nature & Culture",
    proj_explorer_desc:   "Boundless curiosity: I explore deserts, forests, ancient cities, and cultures around the world with the same enthusiasm I bring to engineering and craft.",
